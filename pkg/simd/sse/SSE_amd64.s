...
LBB0_9:
    ...
    LONG $0xbe5c280f; BYTE $0x10 // movaps    xmm3, oword [rsi + 4*rdi + 16]
    LONG $0xbe64280f; BYTE $0x20 // movaps    xmm4, oword [rsi + 4*rdi + 32]
    LONG $0xbe44280f; BYTE $0x30 // movaps    xmm0, oword [rsi + 4*rdi + 48]
    LONG $0xba145c0f             // subps    xmm2, oword [rdx + 4*rdi]
    WORD $0x590f; BYTE $0xd2     // mulps    xmm2, xmm2
    WORD $0x580f; BYTE $0xd1     // addps    xmm2, xmm1
    LONG $0xba5c5c0f; BYTE $0x10 // subps    xmm3, oword [rdx + 4*rdi + 16]
    WORD $0x590f; BYTE $0xdb     // mulps    xmm3, xmm3
    WORD $0x580f; BYTE $0xda     // addps    xmm3, xmm2
    LONG $0xba645c0f; BYTE $0x20 // subps    xmm4, oword [rdx + 4*rdi + 32]
    WORD $0x590f; BYTE $0xe4     // mulps    xmm4, xmm4
    WORD $0x580f; BYTE $0xe3     // addps    xmm4, xmm3
    LONG $0xba445c0f; BYTE $0x30 // subps    xmm0, oword [rdx + 4*rdi + 48]
...
LBB2_8:
    ...
    LONG $0xbe4c280f; BYTE $0x10 // movaps    xmm1, oword [rsi + 4*rdi + 16]
    LONG $0xba34280f             // movaps    xmm6, oword [rdx + 4*rdi]
    LONG $0xba44280f; BYTE $0x10 // movaps    xmm0, oword [rdx + 4*rdi + 16]
